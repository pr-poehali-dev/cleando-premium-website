      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b">
        <div className="container mx-auto px-4">
          <nav className="flex items-center justify-between h-20">
            <img src="https://cdn.poehali.dev/files/c3e40368-05c6-49ac-b9d3-8d18ccff8019.png" alt="CLEANDO" className="h-8" />
      ...
      <footer className="py-12 px-4 border-t">
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <img src="https://cdn.poehali.dev/files/c3e40368-05c6-49ac-b9d3-8d18ccff8019.png" alt="CLEANDO" className="h-6" />
